...
def create_azure_vm(resource_group,
    ...
    if 'error' in az_log:
        ...
        while True:
            try:
                res = subprocess.check_output('ssh -o UserKnownHostsFile=/dev/null -o ConnectTimeout=10 -o StrictHostKeyChecking=no ' +
...
startup_script_path = Path.cwd() / 'scripts' / 'startup_s8.sh'
