...
echo 4800000 > /sys/fs/cgroup/cpu/cgroup_harvest_vm/cpu.cfs_quota_us
...
if [ ! -s /var/lib/hyperv/.kvp_pool_0 ]; then 
    printf "CurrentCoreCount%b%b%b%b48.000%b" "\0" "\0" "\0" "\0" "\0" > /var/lib/hyperv/.kvp_pool_0; 
fi
chmod 777 /var/lib/hyperv/.kvp_pool_0

# set up .kvp_pool_2 (mem in megabytes)
touch /var/lib/hyperv/.kvp_pool_2
printf "CurrentMemoryMB%b%b%b%b196608%b" "\0" "\0" "\0" "\0" "\0" > /var/lib/hyperv/.kvp_pool_2
